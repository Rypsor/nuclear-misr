...
SELECT <%=sourceSystem%>  || 'VendorAccountCreditItem_' || "AP_PAYMENT_SCHEDULES_ALL"."ApPaymentSchedulesAllInvoiceId" || '_'
    ...
    CASE 
        WHEN "NEW_INV_HEADER"."InvoiceHeaderSource" = 'CARGA INICIAL' THEN 'X' ELSE 'No'
    END AS "CargaInicial",
...
WHERE 1=1  
  AND INV."cfdi_content" IS NOT NULL and  "AP_INVOICES_ALL"."ApInvoicesInvoiceTypeLookupCode" = 'STANDARD'
